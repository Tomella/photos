...
let latitude = argv.latitude ? +argv.latitude : NaN; // If it's there coerce to a number
let longitude = argv.longitude ? +argv.longitude : NaN; // If it's there coerce to a number
    ...
    for (var i = 0; i < files.length; i++) {
        ...
        try {
            ...
            if ((tags.GPSLatitude || tags.GPSLatitude === 0) || !isNaN(latitude) && !isNaN(longitude)) {
                ...
                // We have three part heirarchy: Service read => EXIF value => zero
